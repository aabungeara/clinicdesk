...
class PrescriptionModel extends BaseModel
{
    ...
    public function create(array $data): bool 
    {
        ...
        // Safe evaluation mapping strictly against the specified bool return type
        return $result === true;
    }
    ...
    {
        $result = $this->execute(
            "SELECT pr.*, a.appt_date, a.appt_time, a.doctor_id, u.name AS doctor_name
    ...
    {
        return $this->existsByAppointment($appointmentId);
    }
